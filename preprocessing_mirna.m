%STILL NEED TO REMOVE REPEAT SAMPLES AND FIX OUTLIERS
function [mirnafinal, cellid, cellid1, mirnaNorm, fieldNamescell] = preprocessing_mirna()
% open file 
mirna = tdfread('mirna.tsv', '\t');
